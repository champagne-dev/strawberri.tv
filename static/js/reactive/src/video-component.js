  ...
  _tickTock: function(){
    ...
    setTimeout(function(){
      ...
      if(percent >= 100){
        ...
        if((self.state.current_url_index+1) == self.props.current_channel.urls.length && (this.props.current_url_index+1) != self.props.current_channel.urls.length)
          window.location.reload();
        else{
          self.setState({"fakeStart":currenttime, "end": currenttime+(1000*60*5), "current_url_index":this.state.current_url_index+1})
